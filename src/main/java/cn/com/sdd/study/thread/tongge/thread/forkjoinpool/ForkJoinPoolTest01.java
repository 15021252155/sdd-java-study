...
/**
 * @author suidd
 * @name ForkJoinPoolTest01
 * @description 计算1亿个整数的和
 * @date 2020/6/1 16:17
 * Version 1.0
 **/
...
*/
     ...
     * @return change notes
     * @author suidd
     * @description //ThreadPoolExecutor线程池结果相加
     * @date 2020/6/1 16:30
     **/
    private static void multiThreadSum(long[] arr) throws ExecutionException, InterruptedException {
        ...
        List<Future<Long>> list = new ArrayList<>(arr.length);
     ...
     * @return change notes
     * @author suidd
     * @description //ForkJoinPool线程池获取结果
     * @date 2020/6/1 16:30
     **/

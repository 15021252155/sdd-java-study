...
public class MutextNoReentryMain {
    public static void main(String[] args) {
        ...
        上述代码中，第一次调用lock时，主线程获取到锁，可以运行，可以在主线程第二次获取锁的时候，因为锁已经被占用了，所以第二次无法获取。

        由于我们对于一个线程无法获取锁时，就会对其进行阻塞，并加入等待队列。因此第二次获取不到锁，其结果是导致主线程被阻塞了，最终程序就会一直被阻塞。
         */
    }
}
